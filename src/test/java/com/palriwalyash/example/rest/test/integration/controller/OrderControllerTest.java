package com.palriwalyash.example.rest.test.integration.controller;

import static com.palriwalyash.example.rest.test.util.OrderTestUtils.*;
...
import com.palriwalyash.example.rest.repository.OrderRepository;
import com.palriwalyash.example.rest.test.integration.controller.util.OrderControllerTestUtils;
...
public class OrderControllerTest extends ControllerIntegrationTest {
    ...
    public void testGetAllOneOrderEnsureCorrectResponse() throws Exception {
        ...
        getOrder()
        	.andExpect(status().isOk())
        	.andExpect(OrderControllerTestUtils.orderAtIndexIsCorrect(0, injectedOrder));
    }
    ...
    public void testGetAllOneOrderEnsureCorrectLinks() throws Exception {
        ...
        getOrder()
        	.andExpect(status().isOk())
        	.andExpect(OrderControllerTestUtils.orderLinksAtIndexAreCorrect(0, injectedOrder, entityLinks));
    }
    ...
    public void testGetAllTwoOrderEnsureCorrectResponse() throws Exception {
        ...
        getOrder()
        	.andExpect(status().isOk())
        	.andExpect(OrderControllerTestUtils.orderAtIndexIsCorrect(0, injectedOrder1))
        	.andExpect(OrderControllerTestUtils.orderAtIndexIsCorrect(1, injectedOrder2));
    }
    ...
    public void testGetAllTwoOrderEnsureCorrectLinks() throws Exception {
    	...
    	getOrder()
	    	.andExpect(status().isOk())
	    	.andExpect(OrderControllerTestUtils.orderLinksAtIndexAreCorrect(0, injectedOrder1, entityLinks))
	    	.andExpect(OrderControllerTestUtils.orderLinksAtIndexAreCorrect(1, injectedOrder2, entityLinks));
    }
    ...
    public void testGetExistingOrderEnsureCorrectResponse() throws Exception {
        ...
        getOrder(injectedOrder.getId())
        	.andExpect(status().isOk())
        	.andExpect(OrderControllerTestUtils.orderIsCorrect(injectedOrder));
    }
    ...
    public void testGetExistingOrderEnsureCorrectLinks() throws Exception {
    	...
    	getOrder(injectedOrder.getId())
        	.andExpect(status().isOk())
        	.andExpect(OrderControllerTestUtils.orderLinksAreCorrect(injectedOrder, entityLinks));
    }
    ...
    public void testCreateNewOrderEnsureCorrectResponse() throws Exception {
    	...
    	createOrder(TEST_ORDER)
    		...
    		.andExpect(OrderControllerTestUtils.orderIsCorrect(getCreatedOrder()));
    }
    ...
    public void testCreateNewOrderEnsureCorrectLinks() throws Exception {
    	...
    	createOrder(TEST_ORDER)
    		.andExpect(status().isCreated())
    		.andExpect(OrderControllerTestUtils.orderLinksAreCorrect(getCreatedOrder(), entityLinks));
    }
    ...
    public void testUpdateExistingOrderEnsureCorrectResponse() throws Exception {
    	...
    	updateOrder(originalOrder.getId(), updatedOrder)
    		.andExpect(status().isOk())
    		.andExpect(OrderControllerTestUtils.updatedOrderIsCorrect(originalOrder.getId(), updatedOrder));
    }
}
