package com.palriwalyash.example.rest.test.unit.repository;
...
import com.palriwalyash.example.rest.test.util.OrderTestUtils;
...
public class OrderRepositoryTest {
	...
	private Order injectOrder() {
		Order createdOrder = repository.create(OrderTestUtils.generateTestOrder());
		return createdOrder;
	}
	...
	private static void assertOrdersMatch(Order expected, Order actual) {
		...
		OrderTestUtils.assertAllButIdsMatchBetweenOrders(expected, actual);
	}
	...
	public void testUpdateExistingOrderEnsureOriginalOrderIsUpdated() throws Exception {
		...
		Order updatedOrder = OrderTestUtils.generateUpdatedOrder(originalOrder);
		repository.update(originalOrder.getId(), updatedOrder);
		OrderTestUtils.assertAllButIdsMatchBetweenOrders(updatedOrder, originalOrder);
	}
